...
namespace mochi
{
    ...
    {
        MOCHI_VERIFY(InFunctionPtr != nullptr);
        ...
        // TODO: This would require proper conversion from UTF8 to native UC encoding.
    ...
    ManagedAssembly &AssemblyLoadContext::LoadAssembly(std::string_view InFilePath)
    {
        ...
        if (result.m_LoadStatus == AssemblyLoadStatus::Success)
        {
            ...
            // TODO: Is it always desirable to preload every type from an assembly?
            int32_t typeCount = 0;
